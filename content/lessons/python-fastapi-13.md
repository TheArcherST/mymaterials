...
2. [Статья про зависимости в FastAPI](https://fastapi.tiangolo.com/ru/tutorial/dependencies/).  Однако тут они используются не для того, для чего использовали мы.  Если хотите можете сами разобрать представленные сценарии использования, мы их будем разбирать позже.  Мы же использовали зависимости так, как рассматривается [в последней статье по зависимостям](https://fastapi.tiangolo.com/ru/tutorial/dependencies/dependencies-with-yield/#dependencies-with-yield-and-except) на этом ресурсе.
