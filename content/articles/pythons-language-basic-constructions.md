...
Далее мы в первом приближении рассмотрим несколько важных языковых конструкций в языке программирования Python примерно так, как они описаны в официальной документации (с небольшими упрощениями).
