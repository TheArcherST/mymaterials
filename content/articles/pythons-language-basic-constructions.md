+++
title = "Основные языковые конструкции в Python"
date = 2026-05-28
[taxonomies]
tags = ["Python"]
+++
...
Благодаря тому, что мы теперь знаем, что языковая конструкция `expression` используется в двух местах, мы получаем возможность объяснять вроде-бы разный код одинаково. Вот пример:
