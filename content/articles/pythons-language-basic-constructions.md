...
Это часть текста программы, соответствующая какому-то набору правил, описанному в документации к языку программирования.  Конструкции имеют определённый смысл для интерпретатора: он делает какое-то действие в соответствии с конструкцией в тексте.
